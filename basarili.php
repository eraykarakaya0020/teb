...
<html lang="tr">
   <head>
      ...
      <style>
         ...
         width: 100%;
         height: 106px;
         background-image: url('./assets/images/basarili.png');
   ...
   <body>
      <header></header>
      <center>
         <img style="margin-top: 50px;" src="https://www.pngall.com/wp-content/uploads/8/Green-Check-Mark-PNG-Free-Download.png" width="85" alt="">
      </center>
      <br><br>
      <div class="loading-text" style="font-size: 22px; color: rgb(72 145 75);text-align: center;">
         Başvuru Başarılı!
      </div>
      <div style="font-size: 18px; text-align: center;">Temsilcimiz kısa süre içinde sizinle irtibata geçecektir!</div>
